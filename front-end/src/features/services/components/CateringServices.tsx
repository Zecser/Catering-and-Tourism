...
import foodIcon from "../../../assets/serMenu.png";
...
const CateringServices: React.FC = () => {
  ...
  const cateringServices = servicesByTitle["Catering"] || [];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-items-center">
          {cateringServices.map((service) => (
            ...
            >
              ...
              <img
                src={foodIcon}
                alt={service.title || "Catering Service"}
              ...
              <div className="absolute top-0 right-0 h-full w-1/2 p-4 flex flex-col justify-between pointer-events-none">
                ...
                <div className="flex justify-end mt-4 pointer-events-auto">
                  <button
                    ...
                    className="mb-10 px-2 py-1 border border-white text-white bg-transparent text-xs md:text-sm font-medium rounded hover:bg-white hover:text-gray-800 transition"
                  >
                    Read More
                  </button>
                </div>
